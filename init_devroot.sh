#!/bin/bash
echo "ATTENTION SCRIPT BOURRIN. Il va creer des dossiers partout. Il faut le deplacer dans le dossier qui contient /devtools et commenter cette ligne."; exit;

mkdir -p www modules releases repository
