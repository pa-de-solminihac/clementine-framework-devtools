...
do
    ...
    then
        ...
        git clone git@github.com:pa-de-solminihac/clementine-framework-module-${MODULE}.git . || "You should create the repository pa-de-solminihac/clementine-framework-module-${MODULE}"
        cd -
    fi
    ...
    then
        ...
        git clone git@github.com:pa-de-solminihac/clementine-framework-module-${MODULE}-scripts.git . || "You should create the repository git@github.com:pa-de-solminihac/clementine-framework-module-${MODULE}-scripts.git"
        cd -
    fi
